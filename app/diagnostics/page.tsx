...
export default function DiagnosticsPage() {
  return (
    <div className="p-8 space-y-8">
      <header>
        <h1 className="text-3xl font-bold text-white">AI Diagnostics</h1>
        <p className="text-slate-400 mt-2">Review AI decisions, confidence scores, and automated actions.</p>
      </header>
              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-lg font-semibold text-slate-200">Ticket #{1000 + i} Analysis</h2>
                    <span className="px-2 py-0.5 rounded text-xs font-medium bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                      Apphia.Kernel
                    </span>
                  </div>
                  <p className="text-sm text-slate-400 mt-1">"Cannot access billing portal"</p>
                </div>
                <div className="text-right">
                  <span className="text-2xl font-bold text-emerald-400">94%</span>
                  <p className="text-xs text-slate-500 uppercase tracking-wider font-semibold">Confidence</p>
                </div>
              </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300">IntakeAgent</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300">DiagnosisAgent</span>
                <span className="flex items-center gap-1 text-xs text-emerald-400 bg-emerald-400/10 px-2 py-1 rounded-full">
                  <Activity className="w-3 h-3" /> Online
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300">ResolutionAgent</span>
                <span className="flex items-center gap-1 text-xs text-emerald-400 bg-emerald-400/10 px-2 py-1 rounded-full">
                  <Activity className="w-3 h-3" /> Online
                </span>
              </div>
